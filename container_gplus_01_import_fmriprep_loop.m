...
derivatives_dir = 'D:\AVLPlus\derivatives'; % CHECK! Your BIDS derivatives directory
...
cd(fullfile(derivatives_dir(1:length(derivatives_dir)-12))) % CHECK!
...
jobfile = {'D:/AVLPlus/Scripts/fmriprep2spm-main/container_gplus_01_import_fmriprep_res_job.m'};
...
images_dir = dir([prepro_dir]);
images_dir = images_dir(~ismember({images_dir.name},{'.','..'}));
images     = dir([prepro_dir '/**/sub*ses-pre*perception*_res-2_desc-preproc_bold.nii']);
...
addpath C:/Users/Pathfinder/spm12
spm
warning('off', 'MATLAB:MKDIR:DirectoryExists');
for crun = 1:nrun
    subj_ID = images(crun).name(1:8);
